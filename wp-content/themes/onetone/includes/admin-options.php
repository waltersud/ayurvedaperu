...
function optionsframework_options() {
	...
	$section_title       = array("","Sobre Nosotros","Servicios","Galeria","Contactanos","Campus Virtual","");
	...
	$section_content   = array('<div class="banner-box"><br/>
        	<h1>AYURVEDA PERU </h1> <br/> <h1>Dr. Ruben Devoto</h1>
			<div class="sub-title">
            <span>MEDICINA AYUR VEDA POR  RUPANUGA CAITANYA</span></div>
...
Madva Gaudiya Sampradaya.  </p>
            ...
            <div class="one_third last">
                ...
                <ul>
                	<li class="info-phone">3484388</li>
					<li class="info-address">Calle Los Forestales 691-693,
a la altura de La IBM, en La Molina</li>
					<li class="info-email"><a href="#">ayurvedahoy@yahoo.com</a></li>
					<li class="info-website"><a href="#"></a></li>
                </ul>                	
            </div>',
			'<div class="one_third">
			<!-- Font Awesome Icon-->
